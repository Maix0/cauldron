...
#define WS_H
	...
	extern int ws_sendframe(
		int fd, const char *msg, uint64_t size, bool broadcast, bool echo, int type);
	extern int ws_sendframe_txt(int fd, const char *msg, bool broadcast, bool echo);
	extern int ws_sendframe_bin(int fd, const char *msg, uint64_t size, bool broadcast, bool echo);
