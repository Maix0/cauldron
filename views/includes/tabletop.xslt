...
<div class="panel-heading">Event script<span class="zone_group">Zone group: <input id="zone_group" maxlength="10" /></span><span class="glyphicon glyphicon-remove close" aria-hidden="true" onclick="javascript:$('div.script_editor').hide()"></span></div>
...
<li><b>delete [&lt;zone id&gt;]:</b> Delete the triggered or specified a zone.</li>
...
<div class="panel-body" style="max-height:335px">
