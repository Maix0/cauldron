...
<div><b>Fog of War:</b><input type="checkbox" name="fog_of_war"><xsl:if test="map/fog_of_war='yes'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if></input></div>
